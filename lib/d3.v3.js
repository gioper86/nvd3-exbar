d3 = function() {
  ...
  function d3_svg_line2(projection, bandWidth, interval, disContinued) {
    ...
    function line(data) {
      ...
      while (++i < n) {
        if (defined.call(this, d = data[i], i)) {
          var pxdata = xdata(d, i);
          if (typeof xlast !== "undefined" && disContinued) {
            if (pxdata - interval.offset(xlast, 1) > 0) {
              segment();
              points = [];
            }
          }
          xlast = pxdata;
          var px = fx.call(this, d, i);
          var py = fy.call(this, d, i);
          points.push([px, py]);
          var pxnext = fxnext.call(this, d, i);
          points.push([pxnext, py]);
        } else if (points.length) {
          segment();
          points = [];
        }
    ...
    line.xnext = function(_) {
      if (!arguments.length) return xnext;
      xnext = _;
      return line;
    };
    line.y = function(_) {
  ...
  d3.svg.line2 = function(bandWidth, interval, disContinued) {
    return d3_svg_line2(d3_identity, bandWidth, interval, disContinued);
  };
  ...
  function d3_svg_area2(projection, bandWidth, interval, disContinued) {
    var x0 = d3_svg_lineX
      , x1 = d3_svg_lineX
      , xnext = d3_svg_lineX
      , y0 = 0
    ...
    function area(data) {
      ...
      while (++i < n) {
        if (defined.call(this, d = data[i], i)) {
          ...
          xlast = pxdata;
          //console.log('pxdata', pxdata, disContinued);

          //
          var px0 = fx0.call(this, d, i) || 0;
          var py0 = fy0.call(this, d, i) || 0;
          points0.push([ x = +px0, y = +py0 ]);
          //points0.push([ x = +fx0.call(this, d, i), y = +fy0.call(this, d, i) ]);
          var px1 = fx1.call(this, d, i) || 0;
          var py1 = fy1.call(this, d, i) || 0;
          points1.push([ px1, py1 ]);
          //points1.push([ fx1.call(this, d, i), fy1.call(this, d, i) ]);

          //
          //px0 += bandWidth;
          px0 = fxnext.call(this, d, i) || 0;
          points0.push([ x = +px0, y = +py0 ]);
          px1 = px0;
          points1.push([ px1, py1 ]);
  ...
  d3.svg.area2 = function(bandWidth, interval, disContinued) {
    return d3_svg_area2(d3_identity, bandWidth, interval, disContinued);
  };
